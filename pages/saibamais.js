export default function SaibaMais() {
    ...
    return (
        ...
        <div className="containerSaibaMAis p-2 text-center text-primary-dara ">
            ...
            <a style={fontsize} href="https://wa.me/message/OQPASIZH7O75G1" target="_blank" type="button" className="btn btn-primary disabled btn-block btn-large saibamais-btn w-100 ">Agenda fechada!</a>
