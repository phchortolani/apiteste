                            ...
                            <div className="col-lg-6">
                                ...
                                <div className="team">
                                    <div className="image" data-animation="true" data-animation-type="animate__flipInX">
                                        <img className='saibamaispic' src="./saibamaispicture.png" alt="Ryan Teller" />
                                    </div>
                                    <div className="info">
                                        <p>Me siga nas redes sociais!</p>
                                        <div className="social">
                                            <a href="https://web.facebook.com/psidaramarques" target={"_blank"} ><i className="fab fa-facebook-f fa-lg fa-fw"></i></a>
                                            <a href="https://www.instagram.com/psidaramarques/" target={"_blank"}><i className="fab fa-instagram fa-lg fa-fw"></i></a>
                                            <a href="https://www.linkedin.com/in/daramarques/" target={"_blank"}><i className="fab fa-linkedin fa-lg fa-fw"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
